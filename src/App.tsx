            ...
            <Container>
              <nav className="flex items-center justify-between py-6">
                <Link to="/" className="flex items-center space-x-3 group">
                  ...
                  <div>
                    <span className="text-2xl font-black text-transparent bg-clip-text gradient-primary">
                      Iconic
                    </span>
                ...
                <div className="hidden md:flex items-center space-x-8">
                  <Link
                    to="/"
                    className="font-semibold text-gray-700 hover:text-orange-500 transition-all duration-300 relative group"
                  >
                    Trang chủ
                  ...
                  <button className="btn-primary ml-4">📞 Hotline</button>
                </div>
                <div className="md:hidden">
                  <button className="text-gray-700 text-2xl hover:text-orange-500 transition-colors">
                    ☰
                  </button>
                </div>
              </nav>
            ...
            <Container>
              <div className="grid md:grid-cols-4 gap-8 relative z-10">
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed mb-6">
                    Đối tác tin cậy cho mọi nhu cầu vận chuyển và logistics tại Việt Nam. Chúng tôi
                    cam kết mang đến dịch vụ chất lượng cao với công nghệ hiện đại.
                  </p>
              ...
              <div className="border-t border-orange-500/20 mt-12 pt-8 text-center">
                <p className="text-gray-400 text-lg">
                  &copy; 2025{' '}
                  <span className="text-orange-400 font-semibold">Iconic Logistics</span>. Tất cả
                  quyền được bảo lưu.
                </p>
              </div>
            </Container>
