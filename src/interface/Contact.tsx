        ...
        <Container>
          <div className="relative z-10 text-center">
            <h1 className="text-5xl md:text-6xl font-black mb-6">
              Liên Hệ
              <span className="block text-accent-200 text-4xl md:text-5xl mt-2">Với Chúng Tôi</span>
            </h1>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-2xl p-8 shadow-logistics-card">
              <h2 className="text-2xl font-bold text-neutral-900 mb-6">Gửi yêu cầu tư vấn</h2>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-2xl p-8 shadow-logistics-card">
                <h3 className="text-xl font-bold text-neutral-900 mb-4">📍 Vị trí trụ sở</h3>
                <div className="aspect-video bg-neutral-200 rounded-xl mb-4 flex items-center justify-center">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-logistics-card">
                <h3 className="text-xl font-bold text-neutral-900 mb-4">🏢 Văn phòng đại diện</h3>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-neutral-900 transition-colors"
              >
                📧 Gửi email
              </a>
            </div>
